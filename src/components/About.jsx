    ...
    return (
      <>
          <div className="w-full flex flex-row justify-evenly items-center p-10 rounded-xl text-2xl font-semibold">
            ...
            <Button className="w-5/12 md:p-8 p-2 text-sm md:text-xl bg-primary-foreground text-primary hover:text-secondary hover:bg-secondary-foreground">Contact me</Button>
          </div>
      </>
    )
  }
